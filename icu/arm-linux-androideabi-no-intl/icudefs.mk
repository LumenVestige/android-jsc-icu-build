...
prefix = /mnt/extra/worksapce/github/jsc-android-buildscripts/build/target/icu/arm-linux-androideabi-no-intl/prebuilts
exec_prefix = ${prefix}
...
cross_compiling = yes
cross_buildroot = /mnt/extra/worksapce/github/jsc-android-buildscripts/build/target/icu/host
...
SO_TARGET_VERSION = 64.2
SO_TARGET_VERSION_MAJOR = 64
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt64
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt64 
ICUDATA_CHAR = l
...
CPPFLAGS =  -ffunction-sections -fdata-sections $(THREADSCPPFLAGS)  -DU_HAVE_ELF_H=1 -DU_ENABLE_DYLOAD=0 -DU_HAVE_STRTOD_L=0 
